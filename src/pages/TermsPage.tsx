  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#0c0c10' }}>
      ...
      <div className="flex-1 max-w-2xl mx-auto px-6 py-12">
        <h1 className="font-serif text-3xl font-medium mb-6" style={{ color: '#f0ede8' }}>Terms of Service</h1>
        <p className="text-sm leading-relaxed" style={{ color: 'rgba(240,237,232,0.5)', fontFamily: 'Outfit, sans-serif' }}>
          DateOS is provided as-is for personal use. All recommendations are AI-generated for inspiration purposes only. By using DateOS you agree that we are not liable for inaccurate venue information, closures, or any outcomes arising from following a generated plan. Use of this service implies acceptance of these terms.
        </p>
      </div>
      <Footer />
    </div>
